...
Hot leads need to be taken up directly on direct email by sales guys to continue the conversation forward.  
If after conversation with the HOT lead, you send a proposal, thats when you can again copy the assistant to ensure the ball is not dropped after sending the proposal. So the assistant can follow up after proposal is sent.
...
There are 3 buttons for each lead. Website of the lead, LinkedIn connect search, jobs open at that company.  
