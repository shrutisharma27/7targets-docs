...
With achieve the same, we have the bounce rate limit at the organization level. If the Bounce rate limit of 4% is hit then we do not take risk of sending emails to leads email ids which are verified as Risky to send. 
