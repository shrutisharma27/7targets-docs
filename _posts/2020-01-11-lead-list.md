...
- `Followup Range` based search lets you filter leads in that specific range of followups completed. By default, we show all leads irrespective of number of followups completed. In other words, all leads with 0 or more followups completed will be shown by default.   
