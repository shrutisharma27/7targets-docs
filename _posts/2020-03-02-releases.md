...
## 02 Sep 2020
```
- Ability to authorize your Exchange account on Microsoft Office 365 for Assistant. So that Assistant can send and receive email using using Exchange account.
