...
- `Default Schedule` Assistant uses this schedule by default for the added leads. This is used when the leads are added from CRM or by copying Assistant in the email sent by you to your lead. This can be changed by going to Assistant->Edit Assistant.
